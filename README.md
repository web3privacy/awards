...
Public repository of the code for the Web3Privacy Now Awards website -  built with simple web-standard HTML and CSS
...
- The website has a unique subdomain: [awards.web3privacy.info](https://awards.web3privacy.info)

## RELEASES

- [v 1.3.0 - Fresh install from events_web](https://github.com/web3privacy/s25prg/releases/tag/v1.3.0)
